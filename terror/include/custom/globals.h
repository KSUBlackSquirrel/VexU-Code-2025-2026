...
const static int kl_kp = 5; //5
const static int kl_ki = 0;
const static int kl_kd = 19; //19
const static int kl_anti_windup = 0;
const static int kl_small_error_range = 1; //1
const static int kl_small_error_range_timeout = 100; //100
const static int kl_large_error_range = 3; //3
const static int kl_large_error_range_timeout = 500; //500
const static int kl_acceleration = 10; //20

const static int ka_kp = 3; //3
const static int ka_ki = 0;
const static int ka_kd = 24; //24
const static int ka_anti_windup = 0;
const static int ka_small_error_range = 1; //1
const static int ka_small_error_range_timeout = 100; //100
const static int ka_large_error_range = 3; //3
const static int ka_large_error_range_timeout = 500; //500
const static int ka_acceleration = 20; //20
...
namespace outtake {
    ...
    const static char outtakeGateID = 'B';
    const static char outtakeLiftID = 'A';
    static bool outtakeGate = false;
    static bool outtakeLift = false;
}

namespace claw {
    const static char clawID = 'D';
    static bool clawState = false;
}
