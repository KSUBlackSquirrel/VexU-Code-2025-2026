...
const static int kl_kp = 2;
const static int kl_ki = 0;
const static int kl_kd = 10;
const static int kl_anti_windup = 0;
const static int kl_small_error_range = 0; //1
const static int kl_small_error_range_timeout = 0; //100
const static int kl_large_error_range = 0; //500
const static int kl_large_error_range_timeout = 0; //3
const static int kl_acceleration = 0; //20

const static int ka_kp = 2;
const static int ka_ki = 0;
const static int ka_kd = 10;
const static int ka_anti_windup = 0;
const static int ka_small_error_range = 0; //1
const static int ka_small_error_range_timeout = 0; //100
const static int ka_large_error_range = 0; //500
const static int ka_large_error_range_timeout = 0; //3
const static int ka_acceleration = 0; //20
