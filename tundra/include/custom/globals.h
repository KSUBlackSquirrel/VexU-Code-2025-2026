...
const static int kl_small_error_range = 1;
const static int kl_small_error_range_timeout = 100;
const static int kl_large_error_range = 500;
const static int kl_large_error_range_timeout = 3;
const static int kl_acceleration = 0;
